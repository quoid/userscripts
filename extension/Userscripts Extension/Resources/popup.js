(function () {
    ...
    function create_if_block_7(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.textContent = "Injection disabled";
    			attr(div, "class", "warn svelte-151n1y7");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_if_block_6(ctx) {
    	...
    	iconbutton.$on("click", /*click_handler_2*/ ctx[27]);
    	...
    	return {
    		c() {
    			...
    			t1 = space();
    			create_component(iconbutton.$$.fragment);
    			attr(div, "class", "error svelte-151n1y7");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, t0);
    ...
    function create_else_block$1(ctx) {
    	...
    	let each_1_lookup = new Map();
    	let current;
    	let each_value = /*list*/ ctx[15];
    	const get_key = ctx => /*item*/ ctx[34].filename;
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "items svelte-151n1y7");
    		...
    		p(ctx, dirty) {
    			if (dirty[0] & /*list, toggleItem*/ 557056) {
    				const each_value = /*list*/ ctx[15];
    				group_outros();
    ...
    function create_if_block_5(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "none svelte-151n1y7");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		},
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(span, "click", /*click_handler_3*/ ctx[29]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (328:16) {#each list as item (item.filename)}
    function create_each_block$1(key_1, ctx) {
    	...
    	function click_handler_4(...args) {
    		return /*click_handler_4*/ ctx[30](/*item*/ ctx[34], ...args);
    	}

    	popupitem = new PopupItem({
    			props: {
    				enabled: !/*item*/ ctx[34].disabled,
    				name: /*item*/ ctx[34].name,
    				subframe: /*item*/ ctx[34].subframe,
    				type: /*item*/ ctx[34].type
    			}
    		});

    	popupitem.$on("click", click_handler_4);
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*list*/ 32768) popupitem_changes.enabled = !/*item*/ ctx[34].disabled;
    			if (dirty[0] & /*list*/ 32768) popupitem_changes.name = /*item*/ ctx[34].name;
    			if (dirty[0] & /*list*/ 32768) popupitem_changes.subframe = /*item*/ ctx[34].subframe;
    			if (dirty[0] & /*list*/ 32768) popupitem_changes.type = /*item*/ ctx[34].type;
    ...
    // (341:0) {#if !inactive && platform === "macos"}
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div1, "class", "footer svelte-151n1y7");
    		},
    		m(target, anchor) {
    			insert(target, div1, anchor);
    			append(div1, div0);
    ...
    function create_if_block$3(ctx) {
    	...
    	updateview = new UpdateView({
    			props: {
    				closeClick: /*func*/ ctx[32],
    				updateClick: /*updateAll*/ ctx[17],
    				checkClick: /*checkForUpdates*/ ctx[20],
    				loading: /*disabled*/ ctx[3],
    				updates: /*updates*/ ctx[6],
    				updateSingleClick: /*updateItem*/ ctx[18]
    			}
    		});
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty[0] & /*showUpdates*/ 32) updateview_changes.closeClick = /*func*/ ctx[32];
    			if (dirty[0] & /*disabled*/ 8) updateview_changes.loading = /*disabled*/ ctx[3];
    ...
    function create_fragment$6(ctx) {
    	...
    	iconbutton1.$on("click", /*click_handler*/ ctx[23]);
    	...
    	iconbutton2.$on("click", /*click_handler_1*/ ctx[24]);
    	...
    	toggle.$on("click", /*toggleExtension*/ ctx[16]);
    	let if_block0 = !/*active*/ ctx[1] && create_if_block_7(ctx);
    	let if_block1 = /*error*/ ctx[0] && create_if_block_6(ctx);
    	...
    	let if_block3 = !/*inactive*/ ctx[9] && /*platform*/ ctx[10] === "macos" && create_if_block_1$1();
    	let if_block4 = /*showUpdates*/ ctx[5] && create_if_block$3(ctx);
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "header svelte-151n1y7");
    			attr(div1, "class", div1_class_value = "main " + (/*rowColors*/ ctx[8] || "") + " svelte-151n1y7");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(window_1, "resize", /*resize*/ ctx[22]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*rowColors*/ 256 && div1_class_value !== (div1_class_value = "main " + (/*rowColors*/ ctx[8] || "") + " svelte-151n1y7")) {
    				attr(div1, "class", div1_class_value);
    			}
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => $$invalidate(0, error = undefined);
    	...
    	const click_handler_3 = () => window.location.reload();
    	const click_handler_4 = item => toggleItem(item);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*items*/ 16) {
    			 $$invalidate(15, list = items.sort((a, b) => a.name.localeCompare(b.name)));
    		}

    		if ($$self.$$.dirty[0] & /*list*/ 32768) {
