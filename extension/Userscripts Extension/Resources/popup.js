(function () {
    ...
    function create_if_block_6(ctx) {
    	...
    	iconbutton.$on("click", /*click_handler_2*/ ctx[24]);
    ...
    function create_else_block$1(ctx) {
    	...
    	const get_key = ctx => /*item*/ ctx[30].filename;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty[0] & /*list, toggleItem*/ 139264) {
    				const each_value = /*list*/ ctx[13];
    				group_outros();
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(span, "click", /*click_handler_3*/ ctx[25]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	function click_handler_4(...args) {
    		return /*click_handler_4*/ ctx[26](/*item*/ ctx[30], ...args);
    	}

    	popupitem = new PopupItem({
    			props: {
    				enabled: !/*item*/ ctx[30].disabled,
    				name: /*item*/ ctx[30].name,
    				subframe: /*item*/ ctx[30].subframe,
    				type: /*item*/ ctx[30].type
    			}
    		});
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*list*/ 8192) popupitem_changes.enabled = !/*item*/ ctx[30].disabled;
    			if (dirty[0] & /*list*/ 8192) popupitem_changes.name = /*item*/ ctx[30].name;
    			if (dirty[0] & /*list*/ 8192) popupitem_changes.subframe = /*item*/ ctx[30].subframe;
    			if (dirty[0] & /*list*/ 8192) popupitem_changes.type = /*item*/ ctx[30].type;
    ...
    function create_if_block$3(ctx) {
    	...
    	updateview = new UpdateView({
    			props: {
    				closeClick: /*func*/ ctx[28],
    				updateClick: /*updateAll*/ ctx[15],
    				checkClick: /*checkForUpdates*/ ctx[18],
    				loading: /*disabled*/ ctx[3],
    				updates: /*updates*/ ctx[6],
    				updateSingleClick: /*updateItem*/ ctx[16]
    			}
    		});
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty[0] & /*showUpdates*/ 32) updateview_changes.closeClick = /*func*/ ctx[28];
    ...
    function create_fragment$5(ctx) {
    	...
    	iconbutton1.$on("click", /*click_handler*/ ctx[21]);
    	...
    	iconbutton2.$on("click", /*click_handler_1*/ ctx[22]);
    	...
    	iconbutton3.$on("click", /*toggleExtension*/ ctx[14]);
    	let if_block0 = /*error*/ ctx[0] && create_if_block_6(ctx);
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(window_1, "resize", /*resize*/ ctx[20]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    			...
    			if (dirty[0] & /*active*/ 2) iconbutton3_changes.color = /*active*/ ctx[1]
    			? "var(--color-green)"
    			: "var(--color-red)";

    			if (dirty[0] & /*disabled*/ 8) iconbutton3_changes.disabled = /*disabled*/ ctx[3];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*items*/ 16) {
    			 $$invalidate(13, list = items.sort((a, b) => a.name.localeCompare(b.name)));
    		}

    		if ($$self.$$.dirty[0] & /*list*/ 8192) {
