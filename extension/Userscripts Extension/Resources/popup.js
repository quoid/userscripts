(function () {
    ...
    function create_if_block_5(ctx) {
    	...
    	iconbutton.$on("click", /*click_handler_2*/ ctx[19]);
    	...
    	return {
    		c() {
    			...
    			t1 = space();
    			create_component(iconbutton.$$.fragment);
    			attr(div, "class", "error svelte-15k9p5w");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, t0);
    ...
    function create_else_block$1(ctx) {
    	...
    	const get_key = ctx => /*item*/ ctx[23].filename;
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "items svelte-15k9p5w");
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "none svelte-15k9p5w");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		},
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	function click_handler_3(...args) {
    		return /*click_handler_3*/ ctx[20](/*item*/ ctx[23], ...args);
    	}

    	popupitem = new PopupItem({
    			props: {
    				enabled: !/*item*/ ctx[23].disabled,
    				name: /*item*/ ctx[23].name,
    				subframe: /*item*/ ctx[23].subframe,
    				type: /*item*/ ctx[23].type
    			}
    		});
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*list*/ 2048) popupitem_changes.enabled = !/*item*/ ctx[23].disabled;
    			if (dirty & /*list*/ 2048) popupitem_changes.name = /*item*/ ctx[23].name;
    			if (dirty & /*list*/ 2048) popupitem_changes.subframe = /*item*/ ctx[23].subframe;
    			if (dirty & /*list*/ 2048) popupitem_changes.type = /*item*/ ctx[23].type;
    ...
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div1, "class", "footer svelte-15k9p5w");
    		},
    		m(target, anchor) {
    			insert(target, div1, anchor);
    			append(div1, div0);
    ...
    function create_if_block$3(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*showUpdates*/ 32) updateview_changes.closeClick = /*func*/ ctx[22];
    ...
    function create_fragment$5(ctx) {
    	...
    	iconbutton2.$on("click", /*click_handler_1*/ ctx[18]);
    	...
    	iconbutton3.$on("click", /*toggleExtension*/ ctx[12]);
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "header svelte-15k9p5w");
    			attr(div1, "class", div1_class_value = "main " + (/*rowColors*/ ctx[8] || "") + " svelte-15k9p5w");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*active*/ 2) iconbutton3_changes.color = /*active*/ ctx[1]
    			? "var(--color-green)"
    			: "var(--color-red)";

    			if (dirty & /*disabled*/ 8) iconbutton3_changes.disabled = /*disabled*/ ctx[3];
    			...
    			if (!current || dirty & /*rowColors*/ 256 && div1_class_value !== (div1_class_value = "main " + (/*rowColors*/ ctx[8] || "") + " svelte-15k9p5w")) {
    				attr(div1, "class", div1_class_value);
    			}
